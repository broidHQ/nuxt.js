                  ...
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      ...
                      case 3:
                        ...
                        if (_this2.options.build.typescript) {
                          path = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_14__utils__["r"])(_this2.buildDir, dst.replace(".js", ".ts"));
                        }
...
function createWebpackMiddleware() {
  ...
  var host = process.env.HOST || process.env.npm_package_config_nuxt_host || 'localhost';
  ...
  return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 33:
          _context3.prev = 33;
          _context3.t1 // eslint-disable-line no-console
          = _context3['catch'](27);

          console.error('Could not resolve routes' // eslint-disable-line no-console
          );console.error(_context3.t1);process.exit(1);
          throw _context3.t1;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 51:
            ...
            console.error(_context.t0);return _context.abrupt('return', _context.t0);
...
/* harmony default export */ __webpack_exports__["a"] = (function () {
  ...
  if (this.options.build.typescript) {
    config.entry.app = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12_path__["resolve"])(this.buildDir, 'client.ts');
  }
...
/* harmony default export */ __webpack_exports__["a"] = (function () {
  ...
  // Entry
  );var entry = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_path__["resolve"])(this.buildDir, 'server.js');
  if (this.options.build.typescript) {
    entry = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7_path__["resolve"])(this.buildDir, 'server.ts');
  }
